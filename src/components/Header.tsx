        ...
        <nav className="container mx-auto flex justify-between items-center px-4">
          ...
          <div className="hidden md:flex space-x-4">
            <ul className="flex space-x-4">
              ...
              <li><a href="#about" className="text-white hover:text-orange-300 transition-colors duration-200">About</a></li>
              <li><a href="#contact" className="text-white hover:text-orange-300 transition-colors duration-200">Contact</a></li>
            </ul>
          </div>
